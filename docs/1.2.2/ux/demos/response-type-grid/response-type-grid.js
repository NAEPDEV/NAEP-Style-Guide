...
(function() {
  ...
  GridController = (function() {
    function GridController() {
      var ansFn, elim, fn, index, j, k, l, len, len1, len2, len3, len4, len5, len6, len7, len8, m, n, numRows, numSelected, o, option, p, q, r, radioSet, radioSet1, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, selSet, selSetInput;
      ...
      for (l = 0, len2 = ref2.length; l < len2; l++) {
        ...
        fn = function(e) {
          return function() {
            selSet = e.parents('td').siblings('td').find('input:checked').length;
            e.focus();
            ...
            numSelected = e.parents('table.grid').find('.grid-row-selected').length;
        ...
        $(option).parents('td').click(fn($(option)));
      }
        ...
        for (n = 0, len4 = ref4.length; n < len4; n++) {
          ...
          fn = function(e) {
            return function() {
              ...
              e.prop('checked', true);
              e.focus();
              e.parents('td').siblings('td').find('input').prop('checked', false);
              numSelected = e.parents('table.grid').find('.grid-row-selected').length;
              numRows = e.parents('table.grid').find('tr').length - 1;
              if (typeof answerItem == 'function') {
                if (numRows == numSelected) {
