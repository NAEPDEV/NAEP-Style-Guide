module.exports = function (grunt) {
    ...
    grunt.initConfig({
        documentjs: {
            versions: {
                "1.2.2": "https://github.com/NAEPDEV/NAEP-Style-Guide"
            },
        ...
        clean: {
          //  preBuild: ['build', 'node_modules/documentjs/site/templates'],
            preBuild: ['docs', 'node_modules/documentjs/site/templates', 'node_modules/documentjs/site/static/'],
            preRelease: ['release'],
            postRelease: [
                'release/**/.gitignore',
        ...
        uglify: {
            my_target: {
                files: {
                    'docs/ux/demos/shared/master.min.js': ['ux/demos/**/*.js', '!ux/demos/lib/**', '!ux/demos/scratchwork/scratchwork.js', '!ux/demos/tts/tts.js', '!ux/demos/writing-editor/writing-editor-quill.js']
                }
            }
        },
        watch: {
